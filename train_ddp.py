...
def train_epoch(model, dataloader, loss_fn, optimizer, epoch, scaler, scheduler, logger, device, config, rank):
    model.train()
...
def main(rank, world_size, config):  
    ...
    for epoch in range(config['epochs']):
        ...
        train_avg_loss = train_epoch(model, train_dataloader, loss_fn, optimizer, epoch, scaler, scheduler, logger, device, config, rank)
